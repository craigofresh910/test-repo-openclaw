...
- [Claude Code CLI](https://docs.anthropic.com/en/docs/claude-code) installed and authenticated (for `RELAY_BACKEND=claude`)
- Telegram Bot Token (from [@BotFather](https://t.me/BotFather))
- Your Telegram User ID (from [@userinfobot](https://t.me/userinfobot))
- Optional (iMessage mode): [imsg CLI](https://imsg.to) + Messages.app signed in
...
# Required (iMessage mode)
IMESSAGE_CHAT_ID=         # From `imsg chats --limit 10 --json`
IMESSAGE_TO=              # Phone/email handle for replies

# Optional - Backend
RELAY_BACKEND=claude      # claude | openai
OPENAI_API_KEY=
